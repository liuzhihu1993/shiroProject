...
insert into users(username, password, password_salt) values('liu', '123', null);
insert into user_roles(username, role_name) values('liu', 'role1');
insert into user_roles(username, role_name) values('liu', 'role2');
